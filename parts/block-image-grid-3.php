...
<div class="block block-image-grid-3">
    <div class="block-inner">
        <div class="image-grid-3">
            ...
            <div class="image-grid-3__col image-grid-3__col--left">
                <?php if ($left_image) : ?>
            ...
            <div class="image-grid-3__col image-grid-3__col--middle-cards">
                ...
                <?php if ($title_buttom || $text_buttom) : ?>
                    <div class="image-grid-3__card image-grid-3__card--bottom">
                        ...
                        <?php endif; ?>
                        <?php echo $text_buttom; ?>
                    </div>
                <?php endif; ?>

            </div>

            <div class="image-grid-3__col image-grid-3__col--right">
                <?php if ($right_image) : ?>
